...
import { deleteImage } from "../../../main/components/forum/components/singlePost/components/hooks/deleteImage";
...
const EmbedsInput = ({
  ...
  const uploadFile = async (e) => {
    ...
    const imageRef = ref(
      storage,
      `servers/images/${file.name + new Date().getSeconds() + new Date().getTime()}`
    );
  ...
  const handleSubmit = () => {
    createServer(initialServer).unwrap();
  ...
  const handlePrevPage = () => {
    if (initialServer.thumbnail) {
      deleteImage(initialServer.thumbnail);
    }
